<template>
  <div>
    ...
    <main class="container">
      <section class="text-center container mainf">
        <div class="row dashh1">
          <div class="row dashboard">
            <div class="col-2">
              <a href="/" class="buttonktu" type="button" aria-expanded="false"
                >Dashboard
              </a>
            </div>
            <div class="col-10">
              <h1 class="fw-normal">Issue student ID:</h1>
            </div>
          </div>
          <div class="col-lg-6 col-md-8 mx-auto">
            ...
            <button
              ...
              class="btn btn-primary py-2 px-5 _cbtn buttonktu"
            >
  ...
  methods: {
    ...
    async goToWallet(walletId) {
      ...
      let tarkim = Object.keys(cred)
        .filter((key) => key.includes("VerifiableId"))
        .reduce((cur, key) => {
